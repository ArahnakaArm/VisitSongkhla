...
public class HospitalTab extends Fragment{
    ...
    Query Q;
    private FirebaseRecyclerAdapter<CommonModel, HospitalTab.NewsViewHolder> RVAdapter;
    DatabaseReference mRef;
    public static int positionIndex = -1;
    public static int topView = -1;
    LinearLayoutManager linearLayoutManager ;
    private HospitalTab mActivity;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRef = mFirebaseDatabase.getReference("Travel-Hospital").child(getString(R.string.Language));
        Q = mRef;
        ...
        new HospitalTab.MyTasks(HospitalTab.this).execute((Void) null);
...
/*
    ...
    class MyTasks extends AsyncTask<Void, Void, Void> {
        ListView theList;
        public MyTasks(HospitalTab activity) {
            mActivity = activity;
        }
                ...
                public void run() {
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            RVAdapter = new FirebaseRecyclerAdapter<CommonModel, HospitalTab.NewsViewHolder>(foodOptions) {
                                @Override
                                protected void onBindViewHolder(@NonNull HospitalTab.NewsViewHolder holder, int position, final CommonModel model) {
                                    holder.setTitle(model.getTitle());
                                    // holder.setDes(model.getDescription());
                                    holder.setImage(getContext(), model.getUrl());
                                    holder.mView.setOnClickListener(new View.OnClickListener() {
                                ...
                                @NonNull
                                @Override
                                public HospitalTab.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                                    View view = LayoutInflater.from(parent.getContext())
                                            .inflate(R.layout.listitem_places, parent, false);

                                    return new HospitalTab.NewsViewHolder(view);
                                }
                            };
