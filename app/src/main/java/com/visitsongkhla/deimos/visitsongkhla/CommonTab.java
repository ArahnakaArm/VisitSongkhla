...
public class  CommonTab extends Fragment {
    ...
    private FirebaseRecyclerAdapter<CommonModel, CommonTab.NewsViewHolder> RVAdapter;
    DatabaseReference mRef;
    public static int positionIndex = -1;
    public static int topView = -1;
    LinearLayoutManager linearLayoutManager ;
    private CommonTab mActivity;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Q = mRef.orderByChild("type").equalTo(getString(R.string.RE3)+"_"+StringChooseThemes.getTheme());
        ...
        new CommonTab.MyTasks(CommonTab.this).execute((Void) null);
...
/*
    ...
    class MyTasks extends AsyncTask<Void, Void, Void> {
        ListView theList;
        public MyTasks(CommonTab activity) {
            mActivity = activity;
        }
