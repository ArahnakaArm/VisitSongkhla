...
public class  HistiricalTab extends Fragment {
    ...
    Query Q;
    private FirebaseRecyclerAdapter<CommonModel, HistiricalTab.NewsViewHolder> RVAdapter;
    DatabaseReference mRef;
    public static int positionIndex = -1;
    public static int topView = -1;
    LinearLayoutManager linearLayoutManager ;
    private HistiricalTab mActivity;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new HistiricalTab.MyTasks(HistiricalTab.this).execute((Void) null);
...
/*
    ...
    class MyTasks extends AsyncTask<Void, Void, Void> {
        ListView theList;
        public MyTasks(HistiricalTab activity) {
            mActivity = activity;
        }
