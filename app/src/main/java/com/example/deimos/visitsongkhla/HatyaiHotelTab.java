...
public class  HatyaiHotelTab extends Fragment {
    ...
    Query Q;
    private FirebaseRecyclerAdapter<CommonModel, HatyaiHotelTab.NewsViewHolder> RVAdapter;
    DatabaseReference mRef;
    public static int positionIndex = -1;
    public static int topView = -1;
    LinearLayoutManager linearLayoutManager ;
    private HatyaiHotelTab mActivity;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Q = mRef.orderByChild("district").equalTo("หาดใหญ่");
        ...
        new HatyaiHotelTab.MyTasks(HatyaiHotelTab.this).execute((Void) null);
...
/*
    ...
    class MyTasks extends AsyncTask<Void, Void, Void> {
        ListView theList;
        public MyTasks(HatyaiHotelTab activity) {
            mActivity = activity;
        }
        ...
        protected Void doInBackground(Void... params) {
         ...
         /*   FirebaseRecyclerOptions foodOptions = new FirebaseRecyclerOptions.Builder<CommonModel>().setQuery(Q,CommonModel.class).build();
            RVAdapter = new FirebaseRecyclerAdapter<CommonModel, HatyaiHotelTab.NewsViewHolder>(foodOptions) {
                @Override
                ...
                @NonNull
                @Override
                public HatyaiHotelTab.NewsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                    View view = LayoutInflater.from(parent.getContext())
                            .inflate(R.layout.listitem_places, parent, false);

                    return new HatyaiHotelTab.NewsViewHolder(view);
                }
            };
            mRecyclerView.setAdapter(RVAdapter);
            RVAdapter.startListening();
