...
public class  HaralTab extends Fragment {
    ...
    Query Q;
    private FirebaseRecyclerAdapter<CommonModel, HaralTab.NewsViewHolder> RVAdapter;
    DatabaseReference mRef;
    public static int positionIndex = -1;
    public static int topView = -1;
    LinearLayoutManager linearLayoutManager ;
    private HaralTab mActivity;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_haral_tab, container, false);
        ...
        new HaralTab.MyTasks(HaralTab.this).execute((Void) null);
...
/*
    ...
    class MyTasks extends AsyncTask<Void, Void, Void> {
        ListView theList;
        public MyTasks(HaralTab activity) {
            mActivity = activity;
        }
