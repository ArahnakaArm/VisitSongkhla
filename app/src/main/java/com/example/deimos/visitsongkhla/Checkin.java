...
public class Checkin extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       /* Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        ...
        //Toast.makeText(this, "เเผนที่พร้อมใช้งาน", Toast.LENGTH_SHORT).show();
...
*/
       ...
       /* mInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Toast.makeText(MapActivity.this,Placename,Toast.LENGTH_SHORT).show();
                ...
                try{
                    if(mMarker.isInfoWindowShown()){
                        ...
                        Placename=mPlace.getName();
                       /* mRating.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {

                                //Toast.makeText(MapActivity.this,Placename,Toast.LENGTH_SHORT).show();
                                Intent in1 = new Intent(MapActivity.this,CheckIn.class);
                                in1.putExtra("placename",Placename);
                                startActivity(in1);
                            }
                        });
                    }
    ...
    private AdapterView.OnItemClickListener mAutocompleteClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
            ...
            // Toast.makeText(MapActivity.this,placeId,Toast.LENGTH_SHORT).show();
        }
    };
