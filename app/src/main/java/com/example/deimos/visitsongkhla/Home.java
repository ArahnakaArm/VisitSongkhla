...
public class Home extends AppCompatActivity {
    ...
    private void getImages2(){
        ...
        mDes2.add("  เสน่ห์ตลาดกิมหยงตลาดกิมหยง เป็นอีกหนึ่งสถานที่ ที่นําเสนอความเป็นตัวตนของหาดใหญ่ได้ไม่น้อย ถือได้ว่าเป็นจุดนัดwบกับข้าวของราคาหลากหลาย ราคาไม่แwง มีให้เลือกมากมายเดินไปทางไหนก็เต็ม ไปด้วยของกิน มีทั้งแบบที่ต้องนําไปแปรรูปเพื่อ การกิน และของกินแบบสําเร็จรูปต่างๆ ของเล่น เสื้อผ้า ผลไม้หลากชนิด เนื้อที่ของตลาดกว้างใหญ่ และแบ่งเป็น 2 ชั้น ชั้นล่างมีสินค้าพวกอาหารทั้งสด แห้ง ขนมต่างๆ น้ําหอม นาฬิกา เครื่องใช้ไฟฟ้า อีกมากมาย สําหรับชั้น 2 ส่วนมากจะเป็นเครื่องใช้ ไฟฟ้า เช่น VCD, VDO. เครื่องเสียงติดรถยนต์ ราคาก็ต่างกันไป สามารถเลือกดูได้ตามความ เหมาะสม ที่นี่เปิดขายกัน ตั้งแต่เช้าจนถึงพลบค่ํา ถือเป็นแหล่งของฝากที่ใหญ่ที่สุดในตัวเมือง หาดใหญ่ “ตลาดกิมหยง” ถือได้ว่าเป็นย่านสําคัญ ทางด้านเศรษฐกิจการค้า Wราะโดยส่วนใหญ่นัก ท่องเที่ยวทั้งชาวไทย มาเลเซีย หรือสิงคโปร์ เมื่อ มาถึงเมืองหาดใหญ่แล้วต้องไม่wลาดที่จะแวะฉับ จ่ายที่นี่ หาดใหญ่ขึ้นชื่อเรื่องของที่นําเข้าจาก มาเลเซียมากพอสมควร");
